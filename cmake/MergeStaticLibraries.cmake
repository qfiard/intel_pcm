# Source:
# http://code.google.com/p/toadlet/source/browse/cmake/Modules/MergeStaticLibraries.cmake
  ...
  elseif (UNIX)
    ...
    if (NOT MERGE)
      ...
      add_custom_command (TARGET ${TARGET} POST_BUILD
        COMMAND ${CMAKE_COMMAND} -DTARGETLOC=$<TARGET_FILE:${TARGET}> -DLIBRARIES="${LIBRARIES}" -DCMAKE_AR=${CMAKE_AR} -DCMAKE_RANLIB=${CMAKE_RANLIB} -DCMAKE_CURRENT_BINARY_DIR=${CMAKE_CURRENT_BINARY_DIR} -P ${PROJECT_SOURCE_DIR}/cmake/PosixMergeStaticLibraries.cmake)
    endif (NOT MERGE)
  endif (WIN32)
